...
<div class="panel-body">
  ...
  <?php if(settings('dashboard') == 'chart-box'): ?>
  <div class="row">
    <div class="col-md-4" >
        <div class="dashboard-box dashboard-box-chart bg-white content-box">
            <div class="content-wrapper">
                <div class="header" style="font-size: 20px !important;">
                    ...
                    <?php echo e(bangla_digit($todays_stats['total_selling_price'])); ?>

                    <small style="font-size: 12px !important;">
                      (<?php echo e(trans('core.today')); ?>)
                    </small>
                    <span>Sales graph<b> of last 7 Days</b></span>
                </div>
                <div class="bs-label bg-primary">Sale</div>
                <div class="center-div sparkline-big-alt"><?php echo e($lastSevenDaySells); ?></div>
                <div class="row list-grade">
                  <?php $__currentLoopData = $daynames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dayname): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-2" 
                      <?php if($dayname == Carbon\Carbon::now()->format('D')): ?>
            ...
            <div class="button-pane" style="background-color: #00ACA8;">
                <div class="size-md float-left">
                    <a href="<?php echo e(route('invoice.today')); ?>" style="color: white;">
                        View today's invoices
                    </a>
                </div>
                <a class="btn btn-default float-right tooltip-button"  href="<?php echo e(route('invoice.today')); ?>" class="tooltip-button" data-placement="bottom" title="View Invoices">
      ...
      <div class="dashboard-box dashboard-box-chart bg-white content-box">
          <div class="content-wrapper">
              <div class="header" style="font-size: 20px !important;">
                  ...
                  <?php echo e(bangla_digit($todays_stats['total_purchasing_price'])); ?>
              ...
              <div class="center-div sparkline-big-alt"><?php echo e($lastSevenDayPurchases); ?></div>
              <div class="row list-grade">
                  <?php $__currentLoopData = $daynames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dayname): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-2" 
                      <?php if($dayname == Carbon\Carbon::now()->format('D')): ?>
          ...
          <div class="button-pane" style="background-color: #984DFF;">
              <div class="size-md float-left">
                  <a href="<?php echo e(route('bill.today')); ?>" style="color: #FFF;">
                      View today's bills
                  </a>
              </div>
              <a href="<?php echo e(route('bill.today')); ?>" class="btn btn-default float-right tooltip-button" data-placement="top" title="" data-original-title="View Bills">
                  <i class="glyph-icon icon-caret-right"></i>
              </a>
          </div>
      </div>
        ...
        <div class="dashboard-box dashboard-box-chart bg-white content-box">
            <div class="content-wrapper">
                <div class="header" style="font-size: 20px !important;">
                    ...
                    <?php echo e(bangla_digit($todays_stats['total_transactions_today'])); ?>
                ...
                <div class="center-div sparkline-big-alt"><?php echo e($lastSevenDayTransactions); ?></div>
                <div class="row list-grade">
                    <?php $__currentLoopData = $daynames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dayname): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="col-md-2" 
                        <?php if($dayname == Carbon\Carbon::now()->format('D')): ?>
            ...
            <div class="button-pane" style="background-color: #2ECC71;">
                <div class="size-md float-left">
                    <a href="<?php echo e(route('transactions.today')); ?>" style="color: white;" >
                        View today's transactions
                    </a>
                </div>
                <a href="<?php echo e(route('transactions.today')); ?>" class="btn btn-default float-right tooltip-button" data-placement="bottom" title="View Transaction">
                    <i class="glyph-icon icon-caret-right"></i>
                </a>
            </div>
        </div>
  ...
  <?php if(settings('dashboard') == 'tile-box'): ?>
  <div class="row ">
    
    <!--Total invoices today-->
    <div class="col-md-4 col-sm-6 col-xs-12 animated headShake">

      <div class="tile-box tile-box-alt <?php echo e(settings('theme')); ?> font-white">
          <div class="tile-header">
              <?php echo e(trans('core.today_sells')); ?>
          ...
          <div class="tile-content-wrapper">
              ...
              <div class="tile-content">
                <span>
                  <?php echo e(bangla_digit($todays_stats['total_selling_quantity'])); ?>
          ...
          <a href="<?php echo e(route('invoice.today')); ?>" class="tile-footer tooltip-button" data-placement="bottom" title="View Invoices">
              View Invoices
    ...
    <div class="col-md-4 col-sm-6 col-xs-12 animated headShake">
      ...
      <div class="tile-box tile-box-alt bg-blue font-white">
          <div class="tile-header">
              <?php echo e(trans('core.today_purchases')); ?>
          ...
          <div class="tile-content-wrapper">
              ...
              <div class="tile-content">
                <span>
                  <?php echo e(bangla_digit($todays_stats['total_purchasing_quantity'])); ?>
          ...
          <a href="<?php echo e(route('bill.today')); ?>" class="tile-footer tooltip-button" data-placement="bottom" title="View Bills">
              View Bills
              <i class="glyph-icon icon-arrow-right"></i>
          </a>
      </div>
    ...
    <div class="col-md-4 col-sm-6 col-xs-12 animated headShake">
      ...
      <div class="tile-box tile-box-alt <?php echo e(settings('theme')); ?> font-white">
          <div class="tile-header">
              <?php echo e(trans('core.total_transactions_today')); ?>
          ...
          <div class="tile-content-wrapper">
              ...
              <div class="tile-content">
                <span>
                  ...
                  <?php if($todays_stats['total_transactions_today'] != null): ?>
                    <?php echo e(bangla_digit($todays_stats['total_transactions_today'])); ?>

                  <?php else: ?>
                    <?php echo e(bangla_digit(0)); ?>
          ...
          <a href="<?php echo e(route('transactions.today')); ?>" class="tile-footer tooltip-button" data-placement="bottom" title="<?php echo e(trans('core.view_details')); ?>">
              <?php echo e(trans('core.view_details')); ?>
    ...
    <div class="col-md-6 col-xs-12">
      <div class="dashboard-box dashboard-box-chart bg-white content-box">
          <div class="content-wrapper">
            ...
            <?php if(auth()->user()->can('profit.graph')): ?>
  ...
  /*Hot Products*/
      ...
      options: {
        ...
        tooltips: {
          enabled: true,
            callbacks: {
                label: function(tooltipItems, data) { 
                    return '<?php echo e(settings('currency_code')); ?> ' + tooltipItems.yLabel;
                }
            }
        },
    ...
    var chart = new Chart(profitChart, {
      ...
      data: {
          labels: months,
          datasets: [{
              label: "<?php echo e(trans('core.profit')); ?>",
              data: profits,
