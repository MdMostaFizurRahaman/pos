  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><?php echo e(trans('core.add_new_customer')); ?></h5>
      ...
      <div class="modal-body">
		   	...
		   	<div class="row">
			    <div class="col-md-6">
				    <label class="control-label">
				    	<?php echo e(trans('core.first_name')); ?>
				...
				<div class="col-md-6">
					<label class="control-label">
				    	<?php echo e(trans('core.last_name')); ?>
		  ...
		  <div class="row">
		  	<div class="col-md-12">
			    <label class="control-label">
			    	<?php echo e(trans('core.company_name')); ?>
