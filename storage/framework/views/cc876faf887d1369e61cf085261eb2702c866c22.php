...
<?php $__env->startSection('main-content'); ?>
					...
					<div class="col-md-4" style="border: 2px solid #ddd;">
						...
						<div style="min-height: 380px; overflow-y: scroll; ">
							<table class="table table-bordered">
								<tr class=" <?php echo e(settings('theme')); ?> pos-table-header" >
									<td width="30%" class="text-center"><?php echo e(trans('core.product')); ?></td>
									<td width="10%" class="text-center"><?php echo e(trans('core.quantity')); ?></td>
									<td width="25%" class="text-center"><?php echo e(trans('core.unit_price')); ?></td>
									<td width="25%" class="text-center"><?php echo e(trans('core.sub_total')); ?></td>
						...
						<!--POS Table footer-->
						<div class="col-md-12 <?php echo e(settings('theme')); ?>" style="margin-bottom: 10px;">
							<div class="row pos-footer">
								<div class="col-md-12 padLpadR0">
									<table class="pos-table">
										<tr>
											<td width="25%" height="25px">
												<?php echo e(trans('core.total_item')); ?>:
											</td>
									...
									<table class="pos-table">
										<tr>
											<td width="50%" height="30px">
												<?php echo e(trans('core.total_payable')); ?>:
											</td>
						...
						<div class="panel-body">
								...
								<div class="col-md-12 pos-cat-div">
									<div class="regular slider" style="width: 100%">
										<a 
											data-toggle="tab" 
											href="#all" 
											class="pos-single-cat <?php echo e(settings('theme')); ?> active"
										...
										<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<a 
												...
												class="pos-single-cat <?php echo e(settings('theme')); ?>"
												@click="loadProducts(<?php echo e($category->id); ?>)"
							...
							<div style="min-height: 535px;" v-if="loading" >
						  	...
						  	<div v-else class="" style="min-height: 535px;">
						    		...
						    		<div class="col-md-12" >
										<div class="col-md-2 pos-product-col" v-for="product in products" :key="product.id"
											...
											<center>
												...
												<img v-else src="<?php echo e(asset('uploads/products/8NKeIGlWVSCE.png')); ?>" :alt="product.name" class="img-responsive img-rounded">
							    ...
							    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							  		<div role="tabpanel" class="tab-pane" id="tab<?php echo e($category->id); ?>">
							    		<div class="col-md-12" >
	...
	<?php echo $__env->make('pos.partials.customer_form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	<!--Ends-->

	<!--Payment Modal Starts-->
	<?php echo $__env->make('pos.partials.pos-payment', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	<!--Payment Modal Ends-->
    ...
    <script>
    	...
    	var app = new Vue({
		    ...
		    data: {
		        ...
		        barcode: '',
		        discount: 0,
		        enableInvoiceTax: <?php echo e(settings('invoice_tax') ?: 0); ?>,
		        invoice_tax_rate: <?php echo e(settings('invoice_tax_rate') ?: 0); ?>,
		    	invoice_tax_type: <?php echo e(settings('invoice_tax_type') ?: 2); ?>,
		    	paid: 0,
		    	paying_method: 'cash',
		    	reference_no: '',
		    	search: '',
