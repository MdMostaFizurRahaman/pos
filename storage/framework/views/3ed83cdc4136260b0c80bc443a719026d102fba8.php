  ...
  <script defer src="<?php echo e(elixir('app.js')); ?>"></script>
  ...
  <script>
      ...
      $(document).keydown(function(evt){
          ...
          if (evt.keyCode==112){
              evt.preventDefault();
              window.location.href = '<?php echo e(route("sell.form")); ?>';
          }
          ...
          if (evt.keyCode==113){
              evt.preventDefault();
              window.location.href = '<?php echo e(route("purchase.item")); ?>';
          }
          ...
          if (evt.keyCode==116){
              evt.preventDefault();
              window.location.href = '<?php echo e(route("settings.backup")); ?>';
          }
          ...
          if ((evt.ctrlKey) && evt.keyCode==76){
              evt.preventDefault();
              window.location.href = '<?php echo e(url("lock")); ?>';
          }
          ...
          if (evt.keyCode==80 && (evt.altKey) && (evt.ctrlKey)){
              evt.preventDefault();
              window.location.href = '<?php echo e(route("product.new")); ?>';
          }
          ...
          if (evt.keyCode==67 && (evt.altKey)){
              evt.preventDefault();
              window.location.href = '<?php echo e(route("client.index")); ?>';
          }

          //new Client (ALT+CTRL+C)
          if (evt.keyCode==67 && (evt.ctrlKey) && (evt.altKey)){
              evt.preventDefault();
              window.location.href = '<?php echo e(route("client.new")); ?>';
          }
          ...
          if (evt.keyCode==85 && (evt.ctrlKey) && (evt.altKey)){
              evt.preventDefault();
              window.location.href = '<?php echo e(route("user.new")); ?>';
          }

          //Transaction list (ALT+T)
          if (evt.keyCode==84 && (evt.altKey)){
              evt.preventDefault();
              window.location.href = '<?php echo e(route("payment.list")); ?>';
          }
          ...
          if (evt.keyCode==82 && (evt.altKey)){
              evt.preventDefault();
              window.location.href = '<?php echo e(route("report.index")); ?>';
          }
      });
  </script>