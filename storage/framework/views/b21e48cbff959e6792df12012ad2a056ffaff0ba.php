...
<div class="panel-body">
	...
	<h3 class="title-hero"><?php echo e(trans('core.add_new_purchase')); ?></h3>
    		...
    		<table class="table table-bordered bg-purchase">
    			<thead class="<?php echo e(settings('theme')); ?>">
					<tr>
						...
						<td class="text-center font-white" style="width: 15%;">
							<?php echo e(trans('core.unit_cost')); ?>

						</td>
						<td class="text-center font-white" style="width: 15%;">
							<?php echo e(trans('core.quantity')); ?>
						...
						<td class="text-center font-white" style="width: 20%;">
							<?php echo e(trans('core.sub_total')); ?>
				...
				<tbody>
					<tr 
						...
						:id="purchase.id"
						:purchase="purchase"
						:enable_product_tax="<?php echo e(settings('product_tax')); ?>"
						:add="addInput"
						:remove="removeInput"
					></tr>
				</tbody>
				...
				<tfoot>
					<!-- Date -->
					<tr>
						<td colspan="<?php echo e(colSpanNumber()); ?>" <?php if(!rtlLocale()): ?> style="text-align: right; font-weight: bold;" <?php endif; ?>>
					...
					<!-- <tr v-if="enableProductTax == 1">
						<td colspan="<?php echo e(colSpanNumber()); ?>" <?php if(!rtlLocale()): ?> style="text-align: right; font-weight: bold;" <?php endif; ?>>
							<?php echo e(trans('core.total_product_tax')); ?>
					...
					<tr v-if="discount !== 0">
						<td colspan="<?php echo e(colSpanNumber()); ?>" <?php if(!rtlLocale()): ?> style="text-align: right; font-weight: bold;" <?php endif; ?>>
							<?php echo e(trans('core.discount_type')); ?>

						</td>
						<td colspan="2">
							<select v-model="discountType" class="form-control">
								<option value="cash"><?php echo e(trans('core.fixed')); ?></option>
								<option value="percentage"><?php echo e(trans('core.percentage')); ?></option>
							</select>
						</td>
					</tr>
					...
					<tr v-if="this.discountAmount > 0">
						<td colspan="<?php echo e(colSpanNumber()); ?>" <?php if(!rtlLocale()): ?> style="text-align: right; font-weight: bold;" <?php endif; ?>>
							<?php echo e(trans('core.discount_amount')); ?>
					...
					<tr>
						<td colspan="<?php echo e(colSpanNumber()); ?>" <?php if(!rtlLocale()): ?> style="text-align: right; font-weight: bold;" <?php endif; ?>>
							<?php echo e(trans('core.payment_method')); ?>
			...
			>
				...
				<?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<option 
						...
						data-price="<?php echo e($product->cost_price); ?>"
						data-taxrate="<?php echo e($product->tax ? $product->tax->rate : 0); ?>"
						data-taxtype="<?php echo e($product->tax ? $product->tax->type : null); ?>"
					>
    ...
    <script>
    	...
    	var app = new Vue({
		    ...
		    data: {
		    	...
		    	ref_no: '',
		    	enableProductTax: <?php echo e(settings('product_tax')); ?>        
		    },
		    computed: {
		    	total: function () {
		    		var total = 0
