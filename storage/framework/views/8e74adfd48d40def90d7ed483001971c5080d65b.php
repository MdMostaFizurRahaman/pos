              ...
              <div class="content-box wow bounceInDown modal-content pad20A clearfix row">
                  <div class="col-md-3">
                    <?php if(empty($user->image)): ?>
                      <img src="<?php echo e(asset('img/default.png')); ?>" class="img-bordered border-gray radius-all-4 img-full" alt="User Image"/>
                    <?php else: ?>
                      <img src="<?php echo asset('uploads/profiles/'. $user->image); ?>" class="img-bordered border-gray radius-all-4 img-full" alt="User Image"/>
                    <?php endif; ?>
                  </div>
                  <div class="col-md-9">
                      <div class="meta-box text-left">
                          <h3 class="meta-heading font-size-16"><?php echo e($user->name); ?></h3>
                          <h4 class="meta-subheading font-size-13 font-gray"><?php echo e(settings('site_name')); ?></h4>
                          <div class="divider"></div>
                          <?php echo Form::open([ 'route' => 'unlock','method' => 'post', 'class' => 'form-inline pad10T']); ?>
